...
// export function* fetchFilmDataSaga(action): Generator<any, void, unknown> {
//   try {
...
export const fetchFilmData = (filmTitle: string) => ({
  type: FETCH_FILM_DATA as typeof FETCH_FILM_DATA, // Add type assertion
  payload: filmTitle,
});

export const setFilmData = (video: string, description: string) => ({
  type: SET_FILM_DATA as typeof SET_FILM_DATA, // Add type assertion
  payload: { video, description },
});
